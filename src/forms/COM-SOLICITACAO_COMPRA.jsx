...
export default function Form_SolicitacaoCompra() {
  return (
    <>
      <div
      ...
      >
        ...
        <iframe
          id="JotFormIFrame-252535487962065"
          title="COM-SOLIC. COMPRA INSUMO/SERVIÇO"
          onload="window.parent.scrollTo(0,0)"
          allowtransparency="true"
          allow="geolocation; microphone; camera; fullscreen; payment"
          src="https://form.jotform.com/252535487962065"
          frameborder="0"
