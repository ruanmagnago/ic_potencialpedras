...
export default function Form_SaidasBlocosEstoque() {
  return (
    <>
      <div
      ...
      >
        ...
        <iframe
          id="JotFormIFrame-251744047494664"
          title="ADM-SAÍDAS DE BLOCO EM ESTOCAGEM- DEP. POTENCIAL"
          onload="window.parent.scrollTo(0,0)"
          allowtransparency="true"
          allow="geolocation; microphone; camera; fullscreen; payment"
          src="https://form.jotform.com/potencial_pedras/saidas-de-bloco"
          frameborder="0"
