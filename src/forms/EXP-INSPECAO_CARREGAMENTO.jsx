...
export default function Form_InsCarregamento() {
  return (
    <>
      <div
      ...
      >
        ...
        <iframe
          id="JotFormIFrame-252646482304053"
          title="EXP-INSPEÇÃO DE CARREGAMENTO"
          onload="window.parent.scrollTo(0,0)"
          allowtransparency="true"
          allow="geolocation; microphone; camera; fullscreen; payment"
          src="https://form.jotform.com/252646482304053"
          frameborder="0"
