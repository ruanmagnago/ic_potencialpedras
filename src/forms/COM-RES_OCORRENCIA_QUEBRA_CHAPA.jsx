...
export default function Form_RegistroOcorrencia_QuebraChapa() {
  return (
    <>
      <div
      ...
      >
        ...
        <iframe
          id="JotFormIFrame-251325388191661"
          title="COM-REGISTRO DE OCORRENCIA - QUEBRA DE CHAPA"
          onload="window.parent.scrollTo(0,0)"
          allowtransparency="true"
          allow="geolocation; microphone; camera; fullscreen; payment"
          src="https://form.jotform.com/potencial_pedras/quebra_de_chapas"
          frameborder="0"
