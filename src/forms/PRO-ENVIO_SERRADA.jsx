...
export default function Form_EnvioSerrada() {
  return (
    <>
      <div
      ...
      >
        ...
        <iframe
          id="JotFormIFrame-252584894062062"
          title="PRO-ENVIO DE FICHA DE SERRADA"
          onload="window.parent.scrollTo(0,0)"
          allowtransparency="true"
          allow="geolocation; microphone; camera; fullscreen; payment"
          src="https://form.jotform.com/252584894062062"
          frameborder="0"
