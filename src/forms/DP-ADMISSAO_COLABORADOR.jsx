...
export default function Form_AdmissaoColaborador() {
  return (
    <>
      <div
      ...
      >
        ...
        <iframe
          id="JotFormIFrame-250974986786078"
          title=" DP - FICHA DE ADMISSÃO DE COLABORADORES"
          onload="window.parent.scrollTo(0,0)"
          allowtransparency="true"
          allow="geolocation; microphone; camera; fullscreen; payment"
          src="https://form.jotform.com/250974986786078"
          frameborder="0"
